...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form2")) {
  $insertSQL = sprintf("INSERT INTO hospitals (hospital, location) VALUES (%s, %s)",
                ...
                <form action="<?php echo $editFormAction; ?>" method="post" name="form2" id="form2">
                  <table align="center">
                    <tr valign="baseline">
                      ...
                      <td><input name="hospital" type="text" class="maintext" value="" size="32" /></td>
                    </tr>
                    <tr valign="baseline">
