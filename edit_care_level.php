...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form2")) {
  $updateSQL = sprintf("UPDATE care_levels SET carelevel=%s WHERE levelID=%s",
                       GetSQLValueString($_POST['carelevel'], "text"),
                       GetSQLValueString($_POST['levelID'], "int"));

  mysql_select_db($database_adhocConn, $adhocConn);
  $Result1 = mysql_query($updateSQL, $adhocConn) or die("LINE ".__LINE__.": ".mysql_error());

  $updateGoTo = "care_levels.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
if (isset($_GET['levelID'])) {
  $colname_clevel = $_GET['levelID'];
}
mysql_select_db($database_adhocConn, $adhocConn);
$query_clevel = sprintf("SELECT * FROM care_levels WHERE levelID = %s", GetSQLValueString($colname_clevel, "int"));
...
<?php require_once('inc_before.php'); ?>
              ...
              <blockquote>
                ...
                <form action="<?php echo $editFormAction; ?>" method="post" name="form2" id="form2">
                  <table align="center">
                    <tr valign="baseline">
                      <td nowrap="nowrap" align="right">Care level:</td>
                      <td><input type="text" name="carelevel" value="<?php echo htmlentities($row_clevel['carelevel'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
                    </tr>
                    <tr valign="baseline">
                  ...
                  <input type="hidden" name="levelID" value="<?php echo $row_clevel['levelID']; ?>" />
                </form>
                <p align="center"><a href="care_levels.php">Back to Care Levels</a></p>
