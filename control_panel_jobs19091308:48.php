...
<table width="100%" border="0" cellspacing="0" cellpadding="2">
    	<?php
        if ($myregionID == 3) { 
			?><tr><td colspan="7"><table width="100%" border="0" cellpadding="0" cellspacing="5"><tr><?php
			mysql_select_db($database_adhocConn, $adhocConn);
		...
		?>
				...
				?>
                  <tr>
                  <td valign="top" colspan="7"><hr /></td></tr>
                <?php
				}
				?>
                  <tr>
                  ...
                  <?php if ($row_red['comeback'] == 1) { ?>
                        <img src="design/purple.jpg" alt="COMEBACK" title="COMEBACK" width="29" height="29" />
                  <?php } else { ?>
                  ...
                  <td bgcolor="#<?php echo $bgcolor; ?>" valign="top"><div align="center"><?php if ($row_red['job_no']) { echo $row_red['job_no']; } else { echo $row_red['logID']; } ?></div></td>
                  <td bgcolor="#FCE0E0" valign="top"><div align="center"><?php echo date("d M Y", $logtime); ?></div><div align="center"><?php echo date("H:i", $logtime); ?></div></td>
                  <td bgcolor="#FCE0E0" valign="top"><div align="left"><?php
						mysql_select_db($database_adhocConn, $adhocConn);
				  ...
				  ?></div><div align="right"><?php echo $row_red['subregion']; 
				  $tempsubregion = $row_red['subregion']; 
				  ?><br /><span class="subtext2">
                  <td bgcolor="#FCE0E0" valign="top"><div align="right"><?php
				  	if ($row_red['location']) {
						mysql_select_db($database_adhocConn, $adhocConn);
				  ...
				  ?></div></td>
                  <td bgcolor="#FCE0E0" valign="top"><div align="left"><?php echo $row_red['condition']; ?><br /><span class="subtext2">
                  <?php
				  if ($row_red['v1crew1']) {
					mysql_select_db($database_adhocConn, $adhocConn);
                  ...
                  <td bgcolor="#FCE0E0" valign="top" class="subtext"><div align="center" class="subtext"><a href="case_search.php?caseno=<?php echo $row_red['logID']; ?>"><img src="images/more.png" border="0" alt="MORE" title="MORE" hspace="1" width="40" height="40" /></a><a href="info.php?caseno=<?php echo $row_red['logID']; ?>" target="_blank"><img src="images/info.png" border="0" alt="INFO" title="INFO" hspace="1" width="40" height="40" /></a><a href="print_jobcard.php?caseno=<?php echo $row_red['logID']; ?>" target="_blank"><img src="images/jobcard.png" border="0" alt="JOBCARD" title="JOBCARD" hspace="1" width="40" height="40" /></a></div></td>
                </tr>
				...
				?>
                  <tr>
                  <td width="35">
                  <?php if ($row_orange['comeback'] == 1) { ?>
                        <img src="design/purple.jpg" alt="COMEBACK" title="COMEBACK" width="29" height="29" />
                  <?php } else { ?>
					  <?php if (($row_orange['est_fin_time'] > time()) || (!($row_orange['est_fin_time']))) { ?>
                      <img src="design/amber.jpg" width="29" height="29" /></td>
                      <?php } else { ?>
                      <img src="design/amber.gif" width="29" height="29" /></td>
                      <?php } ?>
                  <?php } ?>
                  <?php if (($row_orange['quote_amt']) || ($row_orange['quote_no'])) { $bgcolor = "DDDDDD"; } else { $bgcolor = "FFECCC"; } ?>
                  <td bgcolor="#<?php echo $bgcolor; ?>" valign="top"><div align="center"><?php if ($row_orange['job_no']) { echo $row_orange['job_no']; } else { echo $row_orange['logID']; } ?></div></td>
                  <td bgcolor="#FFECCC"><div align="center"><?php echo date("d M Y", $logtime); ?></div><div align="center"><?php echo date("H:i", $logtime); ?></div></td>
                  <td bgcolor="#FFECCC"><div align="left"><?php
						...
						echo $row_address['streetno'] . " " . $row_address['street'];
						mysql_free_result($address);
				  ?></div><div align="right"><?php echo $row_orange['subregion']; 
				  $tempsubregion = $row_orange['subregion']; ?><br /><span class="subtext2">
				  ...
				  ?></div></td>
                  <td bgcolor="#FFECCC"><div align="left"><?php echo $row_orange['condition']; ?><br /><span class="subtext2">
                  <?php
