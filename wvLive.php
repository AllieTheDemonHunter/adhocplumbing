...
if(isset($_FILES['files'])){
	...
	foreach($_FILES['files']['tmp_name'] as $key => $tmp_name ){
        ...
        if(empty($errors)==true){
			move_uploaded_file($file_tmp,"photos2/1000/".$file_name);
			$Result1 = mysql_query($insertSQL, $adhocConn) or die(mysql_error());
			
			
			
			$dir100 = 'photos2/100/'; // the directory for the thumbnail image
			$dir600 = 'photos2/600/'; // the directory for the original image
			$dir1000 = 'photos2/1000/'; // the directory for the original image
