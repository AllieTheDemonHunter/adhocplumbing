...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form2")) {
	...
	$updateSQL = sprintf("UPDATE fuelman SET `timestamp`=%s, ob_no=%s, vehicleID=%s, person=%s, km=%s, card_no=%s, litres=%s, oil=%s, `value`=%s WHERE fuelID=%s",
...
if (isset($_GET['fuelID'])) {
  $colname_fuel = $_GET['fuelID'];
}
mysql_select_db($database_adhocConn, $adhocConn);
$query_fuel = sprintf("SELECT * FROM fuelman WHERE fuelID = %s", GetSQLValueString($colname_fuel, "int"));
$fuel = mysql_query($query_fuel, $adhocConn) or die(mysql_error());
$row_fuel = mysql_fetch_assoc($fuel);
$totalRows_fuel = mysql_num_rows($fuel);
            ...
            <select name="sd_i" class="maintext" id="sd_i">
                ...
                <option <?php if ($sd_i == "59") {echo "SELECTED";} ?>>59</option>
                  ...
                  <tr valign="baseline">
                    ...
                    <td><input name="ob_no" type="text" class="maintext" value="<?php echo htmlentities($row_fuel['ob_no'], ENT_COMPAT, 'utf-8'); ?>" size="10" /></td>
                  </tr>
                  <tr valign="baseline">
...
do {  
?>
                        <option value="<?php echo $row_vehicles['vehicleID']?>" <?php if (!(strcmp($row_vehicles['vehicleID'], htmlentities($row_fuel['vehicleID'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>><?php echo $row_vehicles['vehicle']?></option>
                        <?php
...
?>
                  ...
                  <tr valign="baseline">
                    ...
                    <td><input name="person" type="text" class="maintext" value="<?php echo htmlentities($row_fuel['person'], ENT_COMPAT, 'utf-8'); ?>" size="12" /></td>
                  </tr>
                  <tr valign="baseline">
                    <td nowrap="nowrap" align="right">Odometer:</td>
                    <td><input name="km" type="text" class="maintext" value="<?php echo htmlentities($row_fuel['km'], ENT_COMPAT, 'utf-8'); ?>" size="6" />
                    km</td>
                  </tr>
                  <tr valign="baseline">
                    <td nowrap="nowrap" align="right">Card no:</td>
                    <td><input name="card_no" type="text" class="maintext" value="<?php echo htmlentities($row_fuel['card_no'], ENT_COMPAT, 'utf-8'); ?>" size="10" /></td>
                  </tr>
                  <tr valign="baseline">
                    <td nowrap="nowrap" align="right">Fuel:</td>
                    <td><input name="litres" type="text" class="maintext" value="<?php echo htmlentities($row_fuel['litres'], ENT_COMPAT, 'utf-8'); ?>" size="5" />
                    litres</td>
                  </tr>
                  <tr valign="baseline">
                    <td nowrap="nowrap" align="right">Oil:</td>
                    <td><input name="oil" type="text" class="maintext" value="<?php echo htmlentities($row_fuel['oil'], ENT_COMPAT, 'utf-8'); ?>" size="5" />
                    ml</td>
                  </tr>
                  <tr valign="baseline">
                    <td nowrap="nowrap" align="right">Value:</td>
                    <td>R
                      <input name="value" type="text" class="maintext" value="<?php echo htmlentities($row_fuel['value'], ENT_COMPAT, 'utf-8'); ?>" size="5" /></td>
                  </tr>
                  <tr valign="baseline">
                ...
                <input type="hidden" name="fuelID" value="<?php echo $row_fuel['fuelID']; ?>" />
              </form>
              <p>&nbsp;</p>
