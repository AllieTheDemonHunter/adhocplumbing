...
$query_calls = sprintf("SELECT * FROM call_log INNER JOIN addresses using (addressID) WHERE logtime > %s AND logtime <= %s AND region = 3 ORDER BY logtime ASC", $settime, $nextmo, $myregionID);
...
<table border="0" align="center" cellpadding="10" cellspacing="0">
  <tr>
    <td><div align="left"><a href="patch_pta.php?settime=<?php echo $prevmo; ?>" class="attention">previous month</a></div></td>
    <td><div align="center"><?php echo date("F Y", $settime); ?></div></td>
    <td><div align="right"><a href="patch_pta.php?settime=<?php echo $nextmo; ?>" class="attention">next month</a></div></td>
  </tr>
</table>
<br />
<table border="1" cellpadding="3" cellspacing="0">
  <tr>
    ...
    <td class="fineprintplain" style="color:#099">Patch</td>
  ...
  <tr>
    ...
    <td class="fineprintplain"><?php 
	  ...
	  ?></td>
    <td class="fineprintplain"><?php echo htmlentities($row_calls['patch_work'],2); ?></td>
