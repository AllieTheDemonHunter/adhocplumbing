                    ...
                    <tr valign="baseline">
					  <td>Geyser:</td>			
					   <td><select name="geyser" class="maintext">
						 <option value="Office(On Site)" <?php if (!(strcmp("Office", $row_call['geyser']))) {echo "selected=\"selected\"";} ?>>Office (On Site)</option>
						 <option value="Client(Off Site)" <?php if (!(strcmp("Client", $row_call['geyser']))) {echo "selected=\"selected\"";} ?>>Client (Off Site)</option>
					   </select></td>
					</tr>
                  <tr valign="baseline">
