  ...
  <tr>
    <td>
        <ul id="MenuBar1" class="MenuBarHorizontal">
          ...
          <li><a href="log_quote_step_1.php?typeID=2&call_status=4" target="_blank">log job</a></li>
          <li><a href="control_panel.php">QUOTES</a></li>
          <li><a href="log_quote_step_1.php?typeID=1&call_status=1">log quote</a></li>
          <li><a href="control_panel_patches.php">PATCHES</a></li>
          <li><a href="log_quote_step_1.php?typeID=3&call_status=4">log patch</a></li>
