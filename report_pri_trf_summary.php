...
$query_primary = sprintf("SELECT casename FROM call_log WHERE logtime > %s AND logtime < %s AND calltype = 1", $settime, $nextmo);
...
mysql_select_db($database_adhocConn, $adhocConn);
$query_transfer = sprintf("SELECT casename FROM call_log WHERE tfrtime > %s AND tfrtime < %s AND calltype = 2", $settime, $nextmo);
...
<?php require_once('inc_before.php'); ?>
              <p>Primary / Transfer Calls Summary</p>
              <table border="0" align="center" cellpadding="10" cellspacing="0">
                <tr>
                  <td><div align="left"><a href="report_pri_trf_summary.php?settime=<?php echo $prevmo; ?>" class="attention">previous month</a></div></td>
                  <td><div align="center"><?php echo date("F Y", $settime); ?></div></td>
                  <td><div align="right"><a href="report_pri_trf_summary.php?settime=<?php echo $nextmo; ?>" class="attention">next month</a></div></td>
                </tr>
              </table>
              <br />
              <table border="0" align="center" cellpadding="5" cellspacing="0">
                <tr>
                  <td><div align="right">Primary calls:</div></td>
                  <td><div align="left"><?php echo $totalRows_primary; ?></div></td>
                  </tr>
                <tr>
                  <td><div align="right">Transfer calls:</div></td>
