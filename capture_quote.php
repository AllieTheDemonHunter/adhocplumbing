...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form2")) {
	$updateSQL = sprintf("UPDATE call_log SET dispatcher=%s, notes=%s, quote_amt=%s, quote_no=%s, call_status=%s WHERE logID=%s",
                       ...
                       GetSQLValueString($_POST['quote_amt'], "double"),
                ...
                <form action="<?php echo $editFormAction; ?>" method="post" name="form2" id="form2">
                  <table border="0" align="center" cellpadding="3" cellspacing="0">
                    ...
                    <tr valign="baseline">
                      ...
                      <td>R
                        <input name="quote_amt" type="text" class="maintext" id="quote_amt" size="4" />
                        </td>
                      <td colspan="3">&nbsp;</td>
                    </tr>
                    ...
                    <tr valign="baseline">
                      ...
                      <td colspan="4"><input name="quote_no" type="text" class="maintext" id="quote_no" size="6" /></td>
                    </tr>
                    <tr valign="baseline">
                      <td colspan="2" align="right" nowrap="nowrap">&nbsp;</td>
                      <td>&nbsp;</td>
                      <td colspan="2"><div align="right">
                        <input type="submit" class="logbutton" value="ENTER QUOTE" />
                      </div></td>
                      </tr>
                  </table>
                  <input type="hidden" name="logtime" value="<?php echo htmlentities($row_call['logtime'], ENT_COMPAT, 'utf-8'); ?>" />
                  <input type="hidden" name="call_status" value="3" />
