...
mysql_select_db($database_adhocConn, $adhocConn);
$query_branches = "SELECT * FROM locations ORDER BY location ASC";
                ...
                <form action="<?php echo $editFormAction; ?>" method="post" name="form2" id="form2">
                  <table align="center">
                    <tr valign="baseline">
                      ...
                      <td><input name="vehicle" type="text" class="maintext" value="" size="32" /></td>
                    </tr>
                    <tr valign="baseline">
                      <td nowrap="nowrap" align="right">Cell No:</td>
                      <td><input name="cellno" type="text" class="maintext" value="" size="10" /></td>
                    </tr>
                    <tr valign="baseline">
                  ...
                  <input type="hidden" name="myregionID" value="<?php echo $myregionID; ?>" />
                </form>
