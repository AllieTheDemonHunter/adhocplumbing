...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form2")) {
  $insertSQL = sprintf("INSERT INTO med_aids (aidname, ambu_co, despatch) VALUES (%s, %s, %s)",
  ...
  $insertGoTo = "insurance_companies.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<?php require_once('inc_before.php'); ?>
              ...
              <blockquote>
                ...
                <form action="<?php echo $editFormAction; ?>" method="post" name="form2" id="form2">
                  <table align="center">
                    <tr valign="baseline">
                      <td nowrap="nowrap" align="right">Co Name:</td>
                      <td><input name="aidname" type="text" class="maintext" value="" size="32" /></td>
                    </tr>
                    <tr valign="baseline">
                      <td nowrap="nowrap" align="right">Plumbing Co:</td>
                      <td><input name="ambu_co" type="text" class="maintext" value="" size="32" /></td>
                    </tr>
                    <tr valign="baseline">
                      <td nowrap="nowrap" align="right">Despatch:</td>
                      <td><select name="despatch" class="maintext">
                          <option value="Phone" <?php if (!(strcmp("Phone", ""))) {echo "SELECTED";} ?>>Phone</option>
                          <option value="Drive" <?php if (!(strcmp("Drive", ""))) {echo "SELECTED";} ?>>Drive</option>
                        </select>
                      </td>
                    </tr>
                    <tr valign="baseline">
                ...
                <p align="center"><a href="insurance_companies.php">Back to Insurance Companies</a></p>
