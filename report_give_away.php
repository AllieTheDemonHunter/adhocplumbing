...
$query_primary = sprintf("SELECT casename FROM call_log WHERE logtime > %s AND logtime < %s AND give_away = 1 AND calltype = 1", $settime, $nextmo);
...
<?php require_once('inc_before.php'); ?>
              <p>Give Away Summary</p>
              <table border="0" align="center" cellpadding="10" cellspacing="0">
                <tr>
                  <td><div align="left"><a href="report_give_away.php?settime=<?php echo $prevmo; ?>" class="attention">previous month</a></div></td>
                  <td><div align="center"><?php echo date("F Y", $settime); ?></div></td>
                  <td><div align="right"><a href="report_give_away.php?settime=<?php echo $nextmo; ?>" class="attention">next month</a></div></td>
                </tr>
              </table>
              <br />
              <table border="0" align="center" cellpadding="5" cellspacing="0">
                <tr>
                  <td><div align="right">Give Aways:</div></td>
