...
$query_primary = sprintf("SELECT casename FROM call_log WHERE logtime > %s AND logtime < %s AND medaid <> 141", $settime, $nextmo);
...
mysql_select_db($database_adhocConn, $adhocConn);
$query_transfer = sprintf("SELECT casename FROM call_log WHERE logtime > %s AND logtime < %s AND medaid = 141", $settime, $nextmo);
...
<?php require_once('inc_before.php'); ?>
              <p>Medical Aid / Private Summary</p>
              <table border="0" align="center" cellpadding="10" cellspacing="0">
                <tr>
                  <td><div align="left"><a href="report_med_aid_private.php?settime=<?php echo $prevmo; ?>" class="attention">previous month</a></div></td>
                  <td><div align="center"><?php echo date("F Y", $settime); ?></div></td>
                  <td><div align="right"><a href="report_med_aid_private.php?settime=<?php echo $nextmo; ?>" class="attention">next month</a></div></td>
                </tr>
              </table>
              <br />
              <table border="0" align="center" cellpadding="5" cellspacing="0">
                <tr>
                  <td><div align="right">Medical Aid:</div></td>
                  <td><div align="left"><?php echo $totalRows_primary; ?></div></td>
                  </tr>
                <tr>
                  <td><div align="right">Private:</div></td>
