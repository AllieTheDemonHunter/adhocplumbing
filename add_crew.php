...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form2")) {
  $insertSQL = sprintf("INSERT INTO crews (crew, cellno, regionID) VALUES (%s, %s, %s)",
                ...
                <form action="<?php echo $editFormAction; ?>" method="post" name="form2" id="form2">
                  <table align="center">
                    <tr valign="baseline">
                      ...
                      <td><input name="crew" type="text" class="maintext" value="" size="15" /></td>
                    </tr>
                    <tr valign="baseline">
                      <td nowrap="nowrap" align="right">Cell no:</td>
                      <td><input name="cellno" type="text" class="maintext" id="cellno" value="27" size="10" />
                      <br />
                      start with 27 eg. 27821234567</td>
                    </tr>
                    <tr valign="baseline">
                      <td nowrap="nowrap" align="right">&nbsp;</td>
                      <td><input type="submit" class="maintext" value="Add Crew" /></td>
                    </tr>
                  </table>
