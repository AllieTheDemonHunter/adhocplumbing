...
$query_primary = sprintf("SELECT casename FROM call_log WHERE logtime > %s AND logtime < %s AND service = 'Service' AND calltype = 1", $settime, $nextmo);
...
mysql_select_db($database_adhocConn, $adhocConn);
$query_transfer = sprintf("SELECT casename FROM call_log WHERE logtime > %s AND logtime < %s AND service <> 'Service' AND calltype = 1", $settime, $nextmo);
...
<?php require_once('inc_before.php'); ?>
              <p>Service / No Service Summary</p>
              <table border="0" align="center" cellpadding="10" cellspacing="0">
                <tr>
                  <td><div align="left"><a href="report_service.php?settime=<?php echo $prevmo; ?>&atype=<?php echo $atype; ?>" class="attention">previous month</a></div></td>
                  <td><div align="center"><?php echo date("F Y", $settime); ?></div></td>
                  <td><div align="right"><a href="report_service.php?settime=<?php echo $nextmo; ?>&atype=<?php echo $atype; ?>" class="attention">next month</a></div></td>
                </tr>
              </table>
              <br />
              <table border="0" align="center" cellpadding="5" cellspacing="0">
                ...
                <tr>
                  <td><div align="right">No Service:</div></td>
